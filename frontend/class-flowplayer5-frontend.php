...
class Flowplayer5_Frontend {
	...
	public function enqueue_scripts() {
		...
		wp_register_script( 'flowplayer5-hlsjs', plugins_url( '/assets/hlsjs/flowplayer.hlsjs.min.js', __FILE__ ), array( 'flowplayer5-script' ), 'adbde54', false );
		...
		wp_register_script( 'magnific-popup', plugins_url( '/frontend/assets/magnific-popup/magnific-popup.js', FP5_PLUGIN_FILE ), array( 'jquery' ), '1.0.0', false );
