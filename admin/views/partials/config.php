...
<table class="form-table">
	<tbody>
		...
		<tr class="fp5-video-attributes" valign="top">
			<th scope="row" rowspan="2"><?php _e( 'Video attributes', $this->plugin_slug )?> <a href="https://flowplayer.org/docs/setup.html#video-attributes" target="_blank">?</a></th>
			<td>
		...
		<tr>
			<td>
				...
				<p><?php _e( 'Caveat: some browsers might not follow the set attribute values or behave unexpectedly, please test carefully.', $this->plugin_slug ); ?> <a href="https://flowplayer.org/docs/setup.html#video-tag-attributes">?</a></p>
			</td>
		</tr>
